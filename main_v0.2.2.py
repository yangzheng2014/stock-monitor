...
运行：
  python main_v0.2.2.py                # 默认监控三环集团（sz300408）
  python main_v0.2.2.py 600519         # 启动即监控贵州茅台
  python main_v0.2.2.py -p 9000        # 指定端口
  python main_v0.2.2.py --no-browser   # 不自动打开浏览器
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .limit-boxes { margin-left: auto; display: flex; gap: 8px; }
  .lbox { display: flex; align-items: baseline; gap: 6px; border-radius: 6px;
          padding: 4px 12px; font-size: 13px; }
  .lbox .l-label { font-size: 11px; opacity: 0.75; }
  .lbox .l-val { font-family: Menlo, monospace; font-weight: 600; font-size: 15px; }
  .lbox-up { background: rgba(239,42,42,0.14); border: 1px solid rgba(239,42,42,0.55); color: #FF6B6B; }
  .lbox-down { background: rgba(20,177,67,0.14); border: 1px solid rgba(20,177,67,0.55); color: #3DDC84; }
...
<body>
  <nav>
    <div class="logo">
      ...
      <span>股票监控</span><span class="ver">v0.2.2</span>
    </div>
  ...
  <section id="monitor">
    <div class="panel">
      <div class="panel-head">
        ...
        <div class="limit-boxes">
          <div class="lbox lbox-up"><span class="l-label">涨停</span><span id="td-limit-up" class="l-val">--</span></div>
          <div class="lbox lbox-down"><span class="l-label">跌停</span><span id="td-limit-down" class="l-val">--</span></div>
        </div>
      </div>
      <div class="stats">
...
def main():
    parser = argparse.ArgumentParser(description="股票监控 v0.2.2（测试版）")
