...
运行：
  python main_v0.2.3.py                # 默认监控三环集团（sz300408）
  python main_v0.2.3.py 600519         # 启动即监控贵州茅台
  python main_v0.2.3.py -p 9000        # 指定端口
  python main_v0.2.3.py --no-browser   # 不自动打开浏览器
...
def main():
    parser = argparse.ArgumentParser(description="股票监控 v0.2.3（测试版）")
